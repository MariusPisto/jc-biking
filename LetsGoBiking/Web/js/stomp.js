  ...
  Client = (function() {
    ...
    Client.prototype.connect = function(login, passcode, connectCallback, errorCallback, vhost) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          switch (frame.command) {
            ...
            case "MESSAGE":
              ...
              //MODIFIED: We do not want auto-ack. User will ack in their onreceive.
      ...
      this.ws.onclose = function() {
        ...
        _this._cleanUp(); // Clean up on close
    ...
    Client.prototype.disconnect = function(disconnectCallback) {
      ...
      this.ws.onclose = null; // Prevent onclose callback from firing on intentional disconnect
      this._cleanUp();
    ...
    Client.prototype.subscribe = function(destination, callback, headers) {
      ...
      // MODIFIED: Do not default to client ack. Let the user pass it in `headers` if they want.
      // if (headers.ack == null) {
      //   headers.ack="client";
      // }
