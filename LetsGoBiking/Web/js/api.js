...
export async function getItinerary(start, end, useDott = false) {
    ...
    const backendUrl = isDemo
        ...
        : `http://localhost:8733/api/itinerary?originLat=${start.lat}&originLng=${start.lon}&destLat=${end.lat}&destLng=${end.lon}&useDott=${useDott}`;
    try {
