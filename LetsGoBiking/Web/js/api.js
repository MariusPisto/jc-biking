...
export async function getItinerary(start, end) {
    ...
    const backendUrl = isDemo
        ? "http://localhost:8733/itinerary?originLat=50.8998481&originLng=4.2808363&destLat=49.5806013&destLng=6.1321121"
        : `http://localhost:8733/itinerary?originLat=${start.lat}&originLng=${start.lon}&destLat=${end.lat}&destLng=${end.lon}`;
    try {
