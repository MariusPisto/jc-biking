...
| **`run_servers_dbg.bat`** | Starts all services in Debug mode (same as above but with Debug builds). Useful for development and debugging. Automatically stops all services when you press Enter. /!\ Do not work without manual compilation /!\ |
